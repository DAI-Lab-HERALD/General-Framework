...
class JSD_traj_joint(evaluation_template):
    ...
    def plot_results(self, Path_in, Path_out, Log, Pred_step, ax, x_lim, y_lim, max_samples):
        ...
        # Path_out.shape = n_samples x n_preds x num_agents x n_O x 2
        # Log.shape      = n_samples x n_preds x 1
    ...
    def get_name(self = None):
        ...
        names = {'print': 'JSD (Trajectories, joint predictions' + P_p + ')',
                 'file': 'JSD_traj_joint' + P_f,
                 'latex': r'\emph{JSD$_{' + P_l + r'\text{Traj}, joint}$}'}
        return names
