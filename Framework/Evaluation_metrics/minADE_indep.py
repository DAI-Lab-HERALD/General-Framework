...
class minADE_indep(evaluation_template):
    r'''
    ...
    def get_name(self = None):
        ...
        names = {'print': 'min ADE (' + N_p + 'independent prediction' + P_p + ')',
                'file': 'minADE' + N_f + '_indep' + P_f,
                'latex': r'\emph{min ADE$_{' + N_l + P_l + r'indep}$ [m]}'}
        return names
