...
class commotions_markkula_L2(model_template, commotions_template):
    '''
    ...
    It uses the original loss function :math:`\mathcal{L}_2` from the paper cited 
    below.
    ...
    def get_name(self = None):
        names = {'print': 'Commotions (Loss 2)',
                 'file': 'commotion2',
                 'latex': r'$\text{\emph{CM}}_{\mathcal{L}_2}$'}
        return names
