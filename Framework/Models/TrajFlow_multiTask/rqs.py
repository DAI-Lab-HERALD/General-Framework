...
def RQS(inputs, unnormalized_widths, unnormalized_heights,
    ...
    widths = min_bin_width + (1 - min_bin_width * num_bins) * widths # make every width at least min_bin_width, but keep total sum of 1 <- TODO: code does not fit comment but does not seem to have an effect
