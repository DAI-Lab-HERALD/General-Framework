...
from Trajectron.trajec_model.components import BayesianLastLayer
from Trajectron.trajec_model.mgcvae import MultimodalGenerativeCVAE
from Trajectron.trajec_model.model_utils import UpdateMode
...
class Trajectron(nn.Module):
    ...
    def train_loss(self, batch: AgentBatch, update_mode: UpdateMode = UpdateMode.BATCH_FROM_PRIOR):
