...
class mid_gu(model_template):
    ...
    def train_method(self):
        ...
        for epoch in range(1, self.config_dict['epochs'] + 1):
            ...
            while not epoch_done:
                ...
                X, Y, T, _, img, _, _, _, num_steps, _, _, epoch_done = self.provide_batch_data('train', self.hyperparams['batch_size'], 
                                                                                               val_split_size = 0.1)
            ...
            if epoch % self.config_dict['eval_every'] == 0:
                ...
                while not eval_done:
                    ...
                    X, Y, T, _, img, _, _, _, num_steps, _, _, eval_done = self.provide_batch_data('val', self.hyperparams['batch_size'], 
                                                                                        val_split_size = 0.1)
    ...
    def predict_method(self):
        ...
        while not prediction_done:
            ...
            X, T, _, img, _, _, _, num_steps, Sample_id, Agent_id, prediction_done = self.provide_batch_data('pred', batch_size)
