...
import random
import scipy
from TrajFlow_GRU.flowModels import TrajFlow_I, Future_Encoder, Future_Decoder, Future_Seq2Seq, Scene_Encoder
import pickle
import os

class trajflow_meszaros_futEnc12_LSTM_past32_weighting(model_template):
    '''
    ...
    def get_name(self = None):
        ...
        names = {'print': 'TrajFlow_fut12_L32W',
                'file': 'TF_f12L32W',
                'latex': r'\emph{TF}'}
        return names
