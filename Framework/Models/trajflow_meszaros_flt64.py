...
import random
import scipy
from TrajFlow.flowModels_flt64 import TrajFlow_I, Future_Encoder, Future_Decoder, Future_Seq2Seq, Scene_Encoder
import pickle
import os

torch.set_default_dtype(torch.float64)

class trajflow_meszaros_flt64(model_template):
    '''
    ...
    def get_name(self = None):
        ...
        model_str = 'TF_flt64_' + kwargs_str
