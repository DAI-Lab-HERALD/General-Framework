...
- **self.predict_single_agent** (bool): This is true if the model is unable to make joint predictions and is only able to predict the future trajectory of one agent at a time.
