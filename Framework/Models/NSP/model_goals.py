...
class NSP_goals(nn.Module):

    def __init__(self, input_size, embedding_size, rnn_size, output_size, encoder_dest_size, dec_tau_size, dt = 0.4):
        '''
        Args:
