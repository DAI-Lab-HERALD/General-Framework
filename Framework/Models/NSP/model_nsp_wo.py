...
class NSP_collisions(nn.Module):

    def __init__(self, input_size, embedding_size, rnn_size, output_size, enc_size, dec_size, dt = 0.4):
        '''
        Args:
        ...
        '''
        super(NSP_collisions, self).__init__()
    ...
    def forward_next_step(self, current_step, current_vel, initial_speeds, dest, features_lstm1, coefficients,
        ...
        tau = self.sigmoid(self.dec_tau(features_tau)) + self.dt
        ...
        w_v = current_vel + delta_t * Force  #peds*2
