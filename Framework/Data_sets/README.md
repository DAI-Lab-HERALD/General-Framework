...
| [HighD - Direction](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/HighD_lane_change.py) | This dataset is HighD with the addition of general behavior classification. | Maneuver (left/right/straight) |
