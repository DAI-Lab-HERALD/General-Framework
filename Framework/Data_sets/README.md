...
| [HighD - Lane change](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/HighD_lane_change.py) | This datasets is a subset of HighD, where only scenarios with lane changes (actual or potential) into the faster lane are included. | Gap acceptance (accept/reject) |
| [InD](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/InD_direction.py) | This is a subset of InD, which is a drone captured dataset of vehicle/pedestrian behavior at German unsignalled intersections. This subset focuses on the prediction of incoming vehicles, given their options of turning or going straight. | Chosen direction (stay, left, straigt, right) |
| [Lyft - Level 5](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/Lyft_interactive.py) | This is a large dataset collected by a vehcile driving through urban Palo Alto (California). | None |
| [NuScenes](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/NuScenes_interactive.py) | This is a meduium sized dataset collected by a vehcile driving through urban Boston (Massachusetts) and Singapore. | None |
| [RounD - Roundabout entry](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/RounD_round_about.py) | This is relatively small drone captured dataset of mainly vehicle behavior at German roundabouts. It focuses on the entry behavior of vehicles, and their decision to enter or wait for vehicles inside the roundabout to pass. | Gap acceptance (accept/reject) |
| [Waymo](https://github.com/DAI-Lab-HERALD/General-Framework/blob/main/Framework/Data_sets/Waymo_interactive.py) | This is a large dataset collected by a vehcile driving through six different American cities. | None |
