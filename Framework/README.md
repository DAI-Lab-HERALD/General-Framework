...
An example of the default output of the *draw_figure()* method can be seen [here](https://github.com/julianschumann/General-Framework/blob/main/Framework/Latex_files/Figure_test.pdf)
